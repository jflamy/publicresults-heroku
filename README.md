## OWLCMS Public Results Scoreboard 34.2.0-beta01
...
[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/${env.REPO_OWNER}/${env.P_REPO_NAME}/tree/34.2.0-beta01)

**Configuration**: [Instructions](https://${env.REPO_OWNER}.github.io/${env.O_REPO_NAME}/#/PublicResults) for installation and how to link the competition system with the public results scoreboard are available [here](https://jflamy-dev.github.io/owlcms4-prerelease/#/PublicResults).
