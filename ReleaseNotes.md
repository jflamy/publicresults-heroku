## OWLCMS Public Results Relay 4.20.2-rc02
...
[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.png)](https://heroku.com/deploy?template=https://github.com/$(RELEASE_USER)/publicresults-heroku$(RELEASE_SUFFIX)/tree/4.20.2-rc02)
