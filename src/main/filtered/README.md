...
**Configuration**: [Instructions](https://${env.REPO_OWNER}.github.io/${env.O_REPO_NAME}/#/Remote) for installation and how to link the competition system with the public results scoreboard are available [here](https://jflamy-dev.github.io/owlcms4-prerelease/#/Remote).
